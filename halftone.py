...
class Halftone:
  ...
  """
  def __init__(self, path, resolution=256, contrast=2, angle=radians(45), verbose=True, save=True, honeycomb=True):
  ...
  def drawTile(self, width, height, radius):
    """
  ...
  def draw(self, regular=True):
    """
    Draws the halftone effect on a new page.
    
    Args:
      regular (bool, optional): Whether to draw the halftone dots regularly or with a honeycomb effect. Defaults to True.
    """
